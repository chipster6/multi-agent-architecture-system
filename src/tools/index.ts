  ...
  return [
    {
      ...
      description: 'Analyze business requirements and translate them into architectural constraints using Phase 1 agents (Requirements, Domain Design, System Topology)',
      inputSchema: {
        type: 'object',
        properties: {
          description: {
    ...
    
    {
      ...
      description: 'Generate complete software architecture documentation using all 40+ specialized agents across phases 2-10 (Infrastructure, Data, Application, AI/ML, Security, Resilience, Performance, DevOps, Governance)',
      inputSchema: {
        type: 'object',
        properties: {
          requirements: {
          ...
          preferences: {
            ...
            properties: {
              ...
              architectureStyle: {
                type: 'string',
                description: 'Preferred architecture style (microservices, monolithic, serverless, etc.)'
              },
    ...
    
    {
      ...
      description: 'Validate architectural decisions for conflicts, compliance, and best practices using conflict resolution agents',
      inputSchema: {
        type: 'object',
        properties: {
          architecture: {
    ...
    
    {
      ...
      description: 'Create detailed implementation plan with task breakdown, timeline, and resource allocation using Phase 11 implementation planning agents',
      inputSchema: {
        type: 'object',
        properties: {
          architecture: {
