...
- [x] Fix redaction correctness:
  - Case-insensitive key matching not working properly
  - Nested objects and arrays redaction failing
  - Custom redact keys not being applied
- [x] Fix sanitization (control characters in all string fields)
...
- [x] All StructuredLogger methods covered
- [x] Redaction covers all denylist keys case-insensitively
- [x] Sanitization escapes all control chars
- [x] Original objects unchanged after logging
...
- [x] All config scenarios covered
- [x] Invalid configs fail with descriptive errors
- [x] Effective dynamic registration computed correctly
...
- [x] All ToolRegistry methods covered
- [x] Edge cases tested (empty registry, max tools)
- [x] Security flags enforced correctly
...
**Note:** Timeout tests don't exist yet - need to create them.
