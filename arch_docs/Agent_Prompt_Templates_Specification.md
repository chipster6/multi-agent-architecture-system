...
| --------------------- | ------------------ | ------------------ | --------------- | ----------------- | --------------------- |
| System Prompts        | Yes Native          | Yes Native          | Yes Native       | Yes Native         | Yes Native             |
| JSON Mode             | Yes Native          | Yes Native          | Yes Native       | Yes Native         | Yes Native             |
| Tool/Function Calling | Yes Native          | Yes Native          | Yes Native       | Yes Native         | Yes Native             |
| Extended Thinking     | Yes Native          | Yes Native          | Yes Native       | Yes Native         | Yes Native             |
| Multi-turn Context    | Yes 256K            | Yes 256K            | Yes 200K         | Yes 200K           | Yes 2M                 |
| Structured Output     | Yes response_format | Yes response_format | Yes Native JSON  | Yes Native JSON    | Yes response_mime_type |
| Agentic Loops         | Yes Native          | Yes Native          | Yes Computer Use | Yes Computer Use   | Yes Native             |
